                ...
                <div>
                    {ScannedQr === PostedCar?.data[0].qr_str ?
                        ...
                        <Container className='Form_container' style={{ marginTop: '0px' }}>
                            <Row>
                                <Col xs="12" md="4">
                                    <div className='page_title' > Fuel check</div>
                                    <div className='page_sub_title' > Enter car's plate info then scan the QR code to check the car's maintaince date</div>
